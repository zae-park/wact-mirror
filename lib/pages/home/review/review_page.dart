              ...
              child: Container(
                ...
                child: TableCalendar(
                  ...
                  calendarStyle: const CalendarStyle(
                    defaultTextStyle: TextStyle(color: Colors.white), // 기본 날짜 색
                    weekendTextStyle: TextStyle(color: Colors.white), // 주말 날짜 색
                    todayTextStyle:
                        TextStyle(color: Colors.white), // 오늘 날짜 숫자 색

                    outsideTextStyle: TextStyle(color: bg_70), // 해당 월이 아닌 날짜
                  ...
                  headerStyle: HeaderStyle(
                      ...
                      headerPadding:
                          EdgeInsets.only(left: 20, top: 40, bottom: 20),
                      ...
                      return FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          ...
                          for (var review in reviews) {
                            print(review['team']); // 각 리뷰의 'team' 필드 값을 출력해봅니다.
                          }
                          ...
                          child: StreamBuilder<List<Map<String, dynamic>>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return ListView.builder(
                                ...
                                controller: scrollController, // 여기 중요!
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  else if (review['compressed_image_urls']
                                      is String) {
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          ...
                                                                          style: const TextStyle(
                                                                              fontSize: 12,
                                                                              fontWeight: FontWeight.w500,
                                                                              color: Colors.black), // 여기에 원하는 스타일 적용
                                                                        ),
                                                                      ],
                                                                    )
                                                                  else
