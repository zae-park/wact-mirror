        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildContent(
                  '이강원(이하 ‘회사\'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 \'정보통신망법\') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.'),
              SizedBox(height: 16.0),
              _buildSectionTitle('제2조(개인정보 처리의 원칙)'),
              _buildContent(
              ...
              SizedBox(height: 16.0),
              _buildSectionTitle('제3조(본 방침의 공개)'),
              _buildContent(
              ...
              SizedBox(height: 16.0),
              _buildSectionTitle('제5조(회원 가입을 위한 정보)'),
              _buildContent(
                  '회사는 이용자의 회사 서비스에 대한 회원가입을 위하여 다음과 같은 정보를 수집합니다.\n\n'
                  '1. 필수 수집 정보: 이름, 생년월일 및 휴대폰 번호'),
              SizedBox(height: 16.0),
              _buildSectionTitle('제6조(본인 인증을 위한 정보)'),
              _buildContent('회사는 이용자의 본인인증을 위하여 다음과 같은 정보를 수집합니다.\n\n'
                  '1. 필수 수집 정보: 이메일 주소'),
              SizedBox(height: 16.0),
              _buildSectionTitle('제7조(회사 서비스 제공을 위한 정보)'),
              _buildContent('회사는 이용자에게 회사의 서비스를 제공하기 위하여 다음과 같은 정보를 수집합니다.\n\n'
                  '1. 필수 수집 정보: 이메일 주소, 이름, 생년월일 및 연락처, 주소(배송지 포함)'),
              SizedBox(height: 16.0),
              _buildSectionTitle('제8조(서비스 이용 및 부정 이용 확인을 위한 정보)'),
              _buildContent(
                  '회사는 이용자의 서비스 이용에 따른 통계∙분석 및 부정이용의 확인∙분석을 위하여 다음과 같은 정보를 수집합니다.\n\n'
                  '1. 필수 수집 정보: 서비스 이용기록'),
              SizedBox(height: 16.0),
              _buildSectionTitle('제9조(개인정보 수집 방법)'),
              _buildContent('회사는 다음과 같은 방법으로 이용자의 개인정보를 수집합니다.\n\n'
              ...
              SizedBox(height: 16.0),
              _buildSectionTitle('제10조(개인정보의 이용)'),
              _buildContent('회사는 개인정보를 다음 각 호의 경우에 이용합니다.\n\n'
              ...
              SizedBox(height: 16.0),
              _buildSectionTitle('제11조(개인정보의 보유 및 이용기간)'),
              _buildContent(
              ...
              SizedBox(height: 16.0),
              _buildSectionTitle('제12조(법령에 따른 개인정보의 보유 및 이용기간)'),
              _buildContent('회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다.\n\n'
              ...
              SizedBox(height: 16.0),
              _buildSectionTitle('제17조(이용자의 의무)'),
              _buildContent(
              ...
              SizedBox(height: 16.0),
              _buildSectionTitle('제18조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)'),
              _buildContent(
              ...
              SizedBox(height: 16.0),
              _buildSectionTitle('제19조(쿠키 설치 허용 지정 방법)'),
              _buildContent('웹브라우저 옵션 설정을 통해 쿠키 허용, 쿠키 차단 등의 설정을 할 수 있습니다.\n\n'
              ...
              SizedBox(height: 16.0),
              _buildSectionTitle('제20조(회사의 개인정보 보호 책임자 지정)'),
              _buildContent(
                  '1. 회사는 이용자의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보 보호 책임자를 지정하고 있습니다.\n\n'
                  '   1. 개인정보 보호 책임자\n'
                  '      1. 성명: 이강원\n'
                  '      2. 직책: 담당자\n'
                  '      3. 전화번호: 010-3420-3632\n'
                  '      4. 이메일: actappofficial@gmail.com'),
              SizedBox(height: 16.0),
              _buildSectionTitle('제21조(권익침해에 대한 구제방법)'),
              _buildContent(
              ...
              SizedBox(height: 16.0),
              _buildSectionTitle('제22조(배송정보의 처리)'),
              _buildContent(
                  '회사는 이용자의 재화 또는 서비스의 배송을 위하여 다음과 같은 정보를 수집 및 이용합니다.\n\n'
                  '1. 수집하는 정보\n'
                  '   1. 필수 수집 정보: 수취인 이름, 연락처, 배송지 주소\n'
                  '   2. 선택 수집 정보: 배송 요청 사항(예: 부재 시 문 앞 배송 등), 현관 비밀번호\n\n'
                  '2. 수집 및 이용 목적\n'
                  '   1. 이용자가 주문한 재화 또는 서비스의 정확한 배송을 위한 정보 제공\n'
                  '   2. 배송 진행 상황에 대한 알림 및 관련 문의 처리\n\n'
                  '3. 보유 및 이용 기간\n'
                  '   1. 배송 완료 후 6개월간 보관 (소비자 분쟁 해결 및 서비스 품질 개선 목적)\n'
                  '   2. 법령에서 정한 경우 해당 기간 동안 보관 (예: 전자상거래 소비자보호법에 따른 기록 보관)\n\n'
                  '4. 수집 방법\n'
                  '   1. 이용자가 주문 과정에서 입력한 배송 정보\n'
                  '   2. 고객센터를 통한 배송지 변경 요청 시 수집'),
              SizedBox(height: 16.0),
              _buildSectionTitle('부칙'),
              _buildSectionTitle('제 1조'),
              _buildContent('본 방침은 2024.01.26부터 시행됩니다.'),
            ],
          ),
        ),
      ),
