...
class MySermonNotePage extends StatefulWidget {
  ...
  @override
  State<MySermonNotePage> createState() => MySermonNotePageState();
}

class MySermonNotePageState extends State<MySermonNotePage> {
  ...
  void refresh() {
    setState(() {
      ...
      debugPrint('MySermonNotePage 새로고침 실행됨');
    });
  }
